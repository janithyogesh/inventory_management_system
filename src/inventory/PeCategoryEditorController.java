...
public class PeCategoryEditorController {
    ...
    private void loadCategories() {
        String sql = "SELECT category_name FROM pe_category";
    ...
    private void applyChanges() {
        ...
        for (String category : addedCategories) {
            String sql = "INSERT INTO pe_category (category_name) VALUES (?)";
            executeUpdate(sql, category);
        }
        for (String category : removedCategories) {
            String sql = "DELETE FROM pe_category WHERE category_name = ?";
            executeUpdate(sql, category);
        }
