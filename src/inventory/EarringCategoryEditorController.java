...
public class EarringCategoryEditorController {
    ...
    private void loadCategories() {
        String sql = "SELECT category_name FROM er_category";
    ...
    private void applyChanges() {
        ...
        for (String category : addedCategories) {
            String sql = "INSERT INTO er_category (category_name) VALUES (?)";
            executeUpdate(sql, category);
        }
        for (String category : removedCategories) {
            String sql = "DELETE FROM er_category WHERE category_name = ?";
            executeUpdate(sql, category);
        }
