...
public class BaCategoryEditorController {
    ...
    private void loadCategories() {
        String sql = "SELECT category_name FROM ba_category";
    ...
    private void applyChanges() {
        ...
        for (String category : addedCategories) {
            String sql = "INSERT INTO ba_category (category_name) VALUES (?)";
            executeUpdate(sql, category);
        }
        for (String category : removedCategories) {
            String sql = "DELETE FROM ba_category WHERE category_name = ?";
            executeUpdate(sql, category);
        }
