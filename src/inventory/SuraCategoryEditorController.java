...
public class SuraCategoryEditorController {
    ...
    private void loadCategories() {
        String sql = "SELECT category_name FROM su_category";
    ...
    private void applyChanges() {
        ...
        for (String category : addedCategories) {
            String sql = "INSERT INTO su_category (category_name) VALUES (?)";
            executeUpdate(sql, category);
        }
        for (String category : removedCategories) {
            String sql = "DELETE FROM su_category WHERE category_name = ?";
            executeUpdate(sql, category);
        }
